...
from aciOps import getTenants, getTenantBDs
...
def main(argv):
    ...
    try:
      ...
      print('aciTenantReCon.py -u <username> -p <password> -i <host_ip>')
      sys.exit(2)
    for opt, arg in opts:
      if opt == '-h':
         print('aciTenantReCon.py -u <username> -p <password> -i <host_ip>')
...
if __name__ == '__main__':
    ...
    tenantResult = getTenants(cliArgs, apicSnacks)
    print(tenantResult)
    tenantBDs = getTenantBDs(cliArgs, apicSnacks, tenantResult)